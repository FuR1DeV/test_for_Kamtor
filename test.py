...
"""По второму заданию очевидным кажется собрание всех пар методом get_margin_all_pairs,
а потом циклом вставить значение symbol в метод get_historical_klines. 
Но по времени скорее всего это было бы очень долго. 
Так что скорее всего я бы читал документацию и гуглил эту проблему.
"""
